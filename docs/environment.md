...
- `GROQ_API_KEY` (packages/ai) is the first link in the AI fallback chain — Groq's free developer tier needs no credit card. `GROQ_MODEL` (optional) overrides the default (`llama-3.3-70b-versatile`).
